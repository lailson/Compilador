...
public RecognizerLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("programa", this), new Integer(30));
	literals.put(new ANTLRHashString("fim", this), new Integer(30));
	literals.put(new ANTLRHashString("escreva", this), new Integer(30));
	literals.put(new ANTLRHashString("leia", this), new Integer(30));
	literals.put(new ANTLRHashString("imprima", this), new Integer(30));
	
	literals.put(new ANTLRHashString("se", this), new Integer(30));
	literals.put(new ANTLRHashString("senao", this), new Integer(30));
	literals.put(new ANTLRHashString("para", this), new Integer(30));
	literals.put(new ANTLRHashString("ate", this), new Integer(30));
	literals.put(new ANTLRHashString("passo", this), new Integer(30));
	literals.put(new ANTLRHashString("enquanto", this), new Integer(30));
	literals.put(new ANTLRHashString("sair", this), new Integer(30));
	literals.put(new ANTLRHashString("funcao", this), new Integer(30));
...
//	literals.put(new ANTLRHashString("aers", this), new Integer(15));
//	literals.put(new ANTLRHashString("aers", this), new Integer(15));
//	literals.put(new ANTLRHashString("imprima", this), new Integer(15));
//	literals.put(new ANTLRHashString("leia", this), new Integer(15));
//	literals.put(new ANTLRHashString("chupaGabriel", this), new Integer(15));
//	literals.put(new ANTLRHashString("aers", this), new Integer(15));
